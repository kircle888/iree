...
#ifndef IREE_HAL_DRIVERS_CUDA_EVENT_POOL_H_
...
// management.
//
// iree_hal_cuda_event_t objects cannot be directly created; they should be
...
typedef struct iree_hal_cuda_event_t iree_hal_cuda_event_t;
...
#endif  // IREE_HAL_DRIVERS_CUDA_EVENT_POOL_H_
