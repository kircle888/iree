...
#ifndef IREE_HAL_DRIVERS_CUDA_CUDA_DYNAMIC_SYMBOLS_H_
#define IREE_HAL_DRIVERS_CUDA_CUDA_DYNAMIC_SYMBOLS_H_
...
#endif  // IREE_HAL_DRIVERS_CUDA_CUDA_DYNAMIC_SYMBOLS_H_
