...
#ifndef IREE_HAL_DRIVERS_CUDA_CUDA_STATUS_UTIL_H_
#define IREE_HAL_DRIVERS_CUDA_CUDA_STATUS_UTIL_H_
...
#define IREE_CUDA_RETURN_AND_END_ZONE_IF_ERROR(zone_id, syms, expr, ...) \
  IREE_RETURN_AND_END_ZONE_IF_ERROR(                                     \
      zone_id,                                                           \
      iree_hal_cuda_result_to_status((syms), ((syms)->expr), __FILE__,   \
                                     __LINE__),                          \
      __VA_ARGS__)
...
iree_status_t iree_hal_cuda_result_to_status(
    const iree_hal_cuda_dynamic_symbols_t* syms, CUresult result,
...
#endif  // IREE_HAL_DRIVERS_CUDA_CUDA_STATUS_UTIL_H_
