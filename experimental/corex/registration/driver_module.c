...
#include "experimental/corex/registration/driver_module.h"
...
#include "experimental/corex/api.h"
...
IREE_FLAG(
    bool, cuda_async_allocations, false,
...
static iree_status_t iree_hal_cuda_driver_factory_enumerate(
  ...
  static const iree_hal_driver_info_t driver_infos[1] = {{
      .driver_name = iree_string_view_literal("corex"),
      .full_name = iree_string_view_literal("COREX (dynamic)"),
  }};
...
static iree_status_t iree_hal_cuda_driver_factory_try_create(
  ...
  *out_driver = NULL;
  ...
  iree_hal_corex_device_params_initialize(&default_params);
  ...
  iree_hal_corex_driver_options_initialize(&driver_options);
  ...
  iree_status_t status =
      iree_hal_corex_driver_create(driver_name, &default_params, &driver_options,
...
iree_hal_corex_driver_module_register(iree_hal_driver_registry_t* registry) {
