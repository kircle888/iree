...
#include "experimental/corex/cuda_device.h"
...
#include "experimental/corex/context_wrapper.h"
#include "experimental/corex/cuda_allocator.h"
#include "experimental/corex/cuda_buffer.h"
#include "experimental/corex/cuda_event.h"
#include "experimental/corex/dynamic_symbols.h"
#include "experimental/corex/event_semaphore.h"
#include "experimental/corex/graph_command_buffer.h"
#include "experimental/corex/memory_pools.h"
#include "experimental/corex/nccl_channel.h"
#include "experimental/corex/nop_executable_cache.h"
#include "experimental/corex/pipeline_layout.h"
#include "experimental/corex/status_util.h"
#include "experimental/corex/stream_command_buffer.h"
#include "experimental/corex/tracing.h"
...
IREE_API_EXPORT void iree_hal_corex_device_params_initialize(
  ...
  out_params->async_allocations = false;
}
...
static iree_status_t iree_hal_cuda_device_query_i64(
  ...
  *out_value = 0;
  ...
  if (iree_string_view_equal(category, IREE_SV("hal.executable.format"))) {
    *out_value = iree_string_view_equal(key, IREE_SV("corex-llvm-ir")) ? 1 : 0;
    return iree_ok_status();
  }
