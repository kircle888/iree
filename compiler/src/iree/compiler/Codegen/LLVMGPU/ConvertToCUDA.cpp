...
/// code.
struct ConvertToCUDAPass : public ConvertToCUDABase<ConvertToCUDAPass> {
  ...
  void runOnOperation() override {
    ...
    }
    {
      ...
      // llvmPatterns); arith::populateArithToLLVMConversionPatterns(converter,
      // llvmPatterns); populateVectorToLLVMConversionPatterns(converter,
      // llvmPatterns); populateGpuToNVVMConversionPatterns(converter,
      // llvmPatterns); populateNVGPUToNVVMConversionPatterns(converter,
      // llvmPatterns); populateGpuWMMAToNVVMConversionPatterns(converter,
      // llvmPatterns);
      populateReconcileUnrealizedCastsPatterns(llvmPatterns);
...
std::unique_ptr<OperationPass<ModuleOp>> createConvertToCUDAPass() {
  return std::make_unique<ConvertToCUDAPass>();
}
